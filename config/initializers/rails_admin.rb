# RailsAdmin config file. Generated on May 13, 2013 12:44
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Vfi', 'Admin']
  ...
  # config.excluded_models = ['Admin', 'Client']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Client']
